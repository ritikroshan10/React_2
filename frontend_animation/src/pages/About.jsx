...
import animationAbout from '../utils/animationAbout';
    ...
    return (
        <section className="bg-white py-10">
            <div className="max-w-[1200px]  mx-auto px-8">
                <h1 className="text-center text-5xl font-bold pb-10 about">About Us</h1>
                ...
                <div className="grid grid-cols-2 gap-10">
                    ...
                    <div className="text-center">
                        <img
                            className="rounded-2xl shadow-lg mx-auto image"
                ...
                <div className="mt-20">
                    <h3 className="Values text-2xl font-semibold text-gray-900 text-center mb-10">Our Core Values</h3>

                    <div className="grid grid-cols-3 gap-8 text-center">
                        <div className="Innovation p-6 bg-gray-50 rounded-2xl shadow hover:shadow-md transition">
                        ...
                        <div className="Integrity p-6 bg-gray-50 rounded-2xl shadow hover:shadow-md transition">
                        ...
                        <div className="User-Focus p-6 bg-gray-50 rounded-2xl shadow hover:shadow-md transition">
