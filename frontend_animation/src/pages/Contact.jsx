...
import animationfForm from "../utils/animationfForm"
    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-[1200px] mx-auto px-8">
        <div className="text-center mb-12">
          <h2 className="heading text-4xl font-bold text-gray-900">Contact Us</h2>
          <p className="para text-gray-600 mt-2">We’d love to hear from you! Fill out the form or reach out directly.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="contact-info p-8 bg-white rounded-2xl shadow-lg space-y-6">
            <div>
